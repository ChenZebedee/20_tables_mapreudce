...
public class BorrowerIdJoinReduce extends Reducer<Text, WideTableWritable, NullWritable, Text> {
    ...
    protected void reduce(Text key, Iterable<WideTableWritable> values, Context context) throws IOException, InterruptedException {
        ...
        for (WideTableWritable wideTableWritable : values) {
            if (key.toString().equals("out2"+wideTableWritable.getTripartitePrimaryKey())){
                context.getCounter("reduceOut","thirdId").increment(1);
        ...
        if (!borrowerList.isEmpty()){
            for (WideTableWritable borrowerWtw : borrowerList) {
                ...
                outWtw.setTBqsQueryData(borrowerWtw.getBqsQueryDataQDId(), borrowerWtw.getBqsQueryDataId(), borrowerWtw.getBqsQueryDataFinalDecision(),borrowerWtw.getBqsQueryDataBorrowerId());
                outWtw.setTBqsStrategy(borrowerWtw.getBqsStrategyQDId(), borrowerWtw.getBqsStrategyId(), borrowerWtw.getStrategyName());
                outWtw.setTBqsRule(borrowerWtw.getBqsRuleStrategyId(), borrowerWtw.getRuleID());
                outWtw.setBqsRuleInfo(borrowerWtw);

                outWtw.setTPaLoanQueryData(borrowerWtw.getPaLoanQueryDataQDId(), borrowerWtw.getPaLoanQueryDataId(),borrowerWtw.getPaLoanQueryDataBorrowerId());
                outWtw.setTPaLoanRecord(borrowerWtw.getPaLoanLoanRecordQDId(),borrowerWtw.getPaLoanLoanRecordId());
                outWtw.setTPaLoanClassification(borrowerWtw.getPaLoanClassificationId(), borrowerWtw.getPaLoanClassificationRId(), borrowerWtw.getPaLoanClassificationClassificationType(), borrowerWtw.getPaLoanClassificationClassificationSection(), borrowerWtw.getPaLoanClassificationOrgNums());
                outWtw.setPaClassInfo(borrowerWtw);

                outWtw.setTHlslQueryData(borrowerWtw.getHlslQueryDataId(), borrowerWtw.getPaLoanQueryDataQDId(),borrowerWtw.getHlslQueryDataBorrowerId(),borrowerWtw.getHlslQueryDataUserName(),borrowerWtw.getHlslQueryDataUserIdCard(),borrowerWtw.getHlslQueryDataUserPhone());
                outWtw.setTHlslHistoryOrg(borrowerWtw.getHlslHistoryOrgQUId(), borrowerWtw.getHlslHistoryOrgCreditCardRepaymentCnt(), borrowerWtw.getHlslHistoryOrgOfflineCashLoanCnt(), borrowerWtw.getHlslHistoryOrgOfflineInstallmentCnt(), borrowerWtw.getHlslHistoryOrgOnlineCashLoanCnt(), borrowerWtw.getHlslHistoryOrgOnlineInstallmentCnt(), borrowerWtw.getHlslHistoryOrgOthersCnt(), borrowerWtw.getHlslHistoryOrgPaydayLoanCnt());
                outWtw.setTHlslHistorySearch(borrowerWtw.getHlslHistorySearchQUId(), borrowerWtw.getHlsrHistorySearchOrgCnt(), borrowerWtw.getHlslHistorySearchSearchCntRecent14Days(), borrowerWtw.getHlslHistorySearchSearchCntRecent180Days(), borrowerWtw.getHlslHistorySearchSearchCntRecent30Days(), borrowerWtw.getHlslHistorySearchSearchCntRecent60Days(), borrowerWtw.getHlslHistorySearchSearchCntRecent7Days(), borrowerWtw.getHlslHistorySearchSearchCntRecent90Days(), borrowerWtw.getHlslHistorySearchSearchCnt(), borrowerWtw.getHlslHistorySearchOrgCntRecent14Days(), borrowerWtw.getHlslHistorySearchOrgCntRecent180Days(), borrowerWtw.getHlslHistorySearchOrgCntRecent30Days(), borrowerWtw.getHlslHistorySearchOrgCntRecent60Days(), borrowerWtw.getHlslHistorySearchOrgCntRecent7Days(), borrowerWtw.getHlslHistorySearchOrgCntRecent90Days());
                outWtw.setTHlslUserBasic(borrowerWtw.getHlslUserBasicQUID(), borrowerWtw.getHlslUserBasicAge(), borrowerWtw.getHlslUserBasicBirthday(), borrowerWtw.getBorrowerInfoSex(), borrowerWtw.getHlslUserBasicIdCardCity(), borrowerWtw.getHlslUserBasicIdCardProvince(), borrowerWtw.getHlslUserBasicIdCardRegion(), borrowerWtw.getHlslUserBasicIdCardValidate(), borrowerWtw.getHlslUserBasicLastAppearIdcard(), borrowerWtw.getHlslUserBasicLastAppearPhone(), borrowerWtw.getHlslUserBasicPhoneCity(), borrowerWtw.getHlslUserBasicPhoneOperator(), borrowerWtw.getHlslUserBasicPhoneProvince(), borrowerWtw.getHlslUserBasicRecordIdCardDays(), borrowerWtw.getHlslUserBasicRecordPhoneDays(), borrowerWtw.getHlslUserBasicUsedIdCardsCnt(), borrowerWtw.getHlslUserBasicUsedPhonesCnt());

                outWtw.setTZxtHighestRisk(borrowerWtw.getZxtHighestRiskQUId(), borrowerWtw.getHighestRiskLevelDescription(), borrowerWtw.getHighestRiskRevel(),borrowerWtw.getZxtHighestRiskBorrowerId());

                outWtw.setSmInfo(borrowerWtw);
